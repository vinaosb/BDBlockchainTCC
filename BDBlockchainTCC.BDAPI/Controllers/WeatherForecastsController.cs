...
namespace BDBlockchainTCC.BDAPI.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class WeatherForecastsController : ControllerBase
    {
        private readonly BDBlockchainTCCBDAPIContext _context;

        public WeatherForecastsController(BDBlockchainTCCBDAPIContext context)
        {
            _context = context;
        }
